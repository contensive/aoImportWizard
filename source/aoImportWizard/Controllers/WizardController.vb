...
Namespace Contensive.ImportWizard.Controllers
    Public Class WizardController
        ...
        Public Shared Sub loadWizardPath(app As ApplicationController)
            Dim cp = app.cp
            Try
                ...
                ImportWizardID = cp.Utils.EncodeInteger(WizardController.getWizardValue(cp, RequestNameImportWizardID, ""))
                '
                ...
                With app.wizard
                    ...
                    Select Case cp.Utils.EncodeInteger(WizardController.getWizardValue(cp, RequestNameImportSource, CType(ImportSourceUpload, String)))
                        ...
                        Case Else
                            ...
                            '
                            '
                            .Path(.PathCnt) = viewIdResourceLibrary
                            .PathCnt = .PathCnt + 1
                    End Select
                    '
                    '
                    '
                    .Path(.PathCnt) = viewIdSelectDestination
                    .PathCnt = .PathCnt + 1
                    '
                    '
                    '
                    ...
                    '
                    '
                    If cp.Utils.EncodeInteger(WizardController.getWizardValue(cp, RequestNameImportContentID, "0")) = cp.Content.GetID("people") Then
                        '
        ...
        ''' <returns></returns>
        Public Shared Function getWizardValue(cp As CPBaseClass, Name As String, DefaultValue As String) As String
